...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Icanmax Chat using Laravel, VueJS, Redis, Laravel Echo, SocketIO">
        <meta name="keywords" content="Icanmax Chat, Laravel, VueJS, Laravel Echo, Redis, SocketIO">
